...
export default {
    ...
    RemoveProblemThreadsTooltip: `This button will reveal checkboxes next to each problem thread. 
        Use them to select problem threads to remove.`,
    WorkflowActivitySingleProblemTooltip: `To the left is the internal ID and name of this assignment's problem type.
        Below are all of the problem threads grouped for this problem type.`,
    WorkflowActivityMultipleProblemTooltip: `This assignment has multiple problem types.
        To the left is the internal ID and name of one of these problem types.
        Below are all of the problem threads grouped for this problem type.`,
    WorkflowInstanceTooltip: `Each row shows all of the tasks for one of the problem threads 
            and their current status. The internal problem thread ID is at the start of the row.
            Hover over any task for more options.`,
    ...
    RemoveSelectedProblemThreadsTooltip: `Click to remove the checked problem threads.
        ...
        It is most efficent to remove multiple problem threads at once instead of doing this individually.`,
