...
import "./About.scss"
import processImage from '../../assests/images/process-figure.png'

class About extends Component { //create a class for the component
        ...
        return (
            <div className="about">
                <div className="pl-description">
                    <div className="section">
                        ...
                        <div className="section-content">
                            ...
                            <ul>
                                <li><span ><i className="fa fa-check icon"/></span>{strings.Step0}</li>
                                <li><span ><i className="fa fa-check icon"/></span>{strings.Step1}</li>
                                <li><span ><i className="fa fa-check icon"/></span>{strings.Step2}</li>
                                <li><span ><i className="fa fa-check icon"/></span>{strings.Step3}</li>
                                <li><span ><i className="fa fa-check icon"/></span>{strings.Step4}</li>
                                <li><span ><i className="fa fa-check icon"/></span>{strings.Step5}</li>
                                <li><span ><i className="fa fa-check icon"/></span>{strings.Step6}</li>
                                <li><span ><i className="fa fa-check icon"/></span>{strings.Step7}</li>
                            </ul>
                            <img src={processImage} style={{width: '100%'}} alt={"Imagine describing the PL Framework"}/>
                    </div>
                    </div>
                </div>
                <div className="developers-section">
                    <div className="section" style={{minWidth: "95%"}}>
                        <h2 className="title" style={{width: "90%"}}>{strings.SectionTitle0}</h2>
                    </div>
                    {
                ...
                <div className="contact-section">
                    <div className="section" style={{minWidth: "95%"}}>
                        <h2 className="title" style={{width: "80%"}}>{strings.SectionTitle1}</h2>
                    </div>
                    ...
                    <div className="section">
                        ...
                        <div className="section-content">
                            <ul>
                                ...
                                <li style={{textAlign: 'left'}}><a href="http://web.njit.edu/~bieber/pubs.html#p" target="_blank" rel="noopener noreferrer">http://web.njit.edu/~bieber/pubs.html#p</a></li>
                            </ul>
                        </div>
                    </div>
