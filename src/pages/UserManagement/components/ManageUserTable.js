...
export default function ManageUserTable(props) {
    ...
    const makeTableRow = users => (
        ...
        if(organizationGroup){
            orgs = props.organizations.map(org => {
        ...
        return {
            ...
            systemRole:(
                <PLSelect
                    onChange={props.onRoleChange.bind(this, userID, user.FirstName+" "+user.LastName,userRole)}
                    value={userRole}
            ...
            blockedStatus: (
                <PLToggleSwitch
                    checked={isBlocked}
                    onChange={props.onBlockedStatusChange.bind(this, userID, email, isBlocked)}
                />),
            resetPassword: (
                <PLButton
                    type='button'
                    onClick={props.onChangePassword.bind(this, email)}
                >
                    Reset
                </PLButton>
            ),
            removeUser: (
                <PLButton
                    type='button'
                    onClick={props.onRemoveUser.bind(this, userID, email)}
                >
                    Remove
                </PLButton>),
    ...
    const tableData = makeTableRow(props.users);
